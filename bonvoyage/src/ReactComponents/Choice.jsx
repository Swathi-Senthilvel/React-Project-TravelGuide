                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="Food"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Food"><Button variant="contained" size="large" color='secondary'>FOOD</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Accomodation"><Button variant="contained" size="large" color='secondary'>ACCOMODATION</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Bn"><Button variant="contained" size="large" color='secondary'>BASIC NEEDS</Button></Link></Typography>
              </div>
            </div>
            <div style={{display: 'flex',
                  flexWrap: 'wrap',
                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="Entertainment"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Entertainment"><Button variant="contained" size="large" color='secondary'>ENTERTAINMENT</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Transport"><Button variant="contained" color="secondary">TRANSPORT</Button></Link></Typography>
              </div>
            </div>
          </Paper>
        </Grid>
