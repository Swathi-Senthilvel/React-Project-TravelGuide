...
export default class Choice extends Component {
  render() {
    return (
      <div style={{backgroundImage:'url(../pexels8.jpg)',height:'110vh',
      marginTop:'0px',
      padding:'0px',
      fontSize:'50px',
      ...
      <Typography><h1 align="center">ENJOY THE WORLD</h1></Typography>
        <Grid align="center" padding={"10px"} marginBottom="100px">
          <Paper variant='outlined' style={{width:'1200px',height:'710px', borderRadius:'20px' ,opacity:'0.7'}}>
            <Typography><h2>CHOOSE YOUR DESTINATION</h2></Typography>
                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="KERALA"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Choice"><Button variant="contained" size="large" color='secondary'> KERALA</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Choice"><Button variant="contained" size="large" color='secondary'>HYDERABAD</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Choice"><Button variant="contained" size="large" color='secondary'>SHIMLA</Button></Link></Typography>
              </div>
            </div>
            <div style={{display: 'flex',
                  flexWrap: 'wrap',
                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="delhi"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Choice"><Button variant="contained" size="large" color='secondary'>DELHI</Button></Link></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Link to="../Choice"><Button variant="contained" size="large" color='secondary'>KASHMIR</Button></Link></Typography>
              </div>
            </div>
          </Paper>
        </Grid>
