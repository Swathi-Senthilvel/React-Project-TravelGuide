...
export default class Likedtrips extends Component {
    ...
    buttonstyle2={color:'#F5F3E1',backgroundColor:'#F58484 ',borderColor:'#0480AB',marginLeft:'80px', marginTop:'30px',marginBottom:'20px',padding:'5px',align:'center',fontSize:'20px'}
    
  render() {
    return (
      <div style={{backgroundImage:'url(../liked.jpg)',height:'100vh',
