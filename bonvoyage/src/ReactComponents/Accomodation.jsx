                ...
                <div style={this.divstyle}>
                  <Box 
                      ...
                      sx={this.boxstyle}
                          ...
                          alt="camper"
                  />   
                  <Typography style={this.typostyle}><Button variant="contained" size="large" color='secondary'>CAMPER VAN STAY</Button></Typography>
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />   
                  <Typography style={this.typostyle}><Button variant="contained" size="large" color='secondary'>RESORT STAY</Button></Typography>
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />   
                  <Typography style={this.typostyle}><Button variant="contained" size="large" color='secondary'>BOAT HOUSE STAY</Button></Typography>
                </div>
              </div>
                ...
                <div style={this.divstyle}>
                  <Box 
                      ...
                      sx={this.boxstyle}
                          ...
                          alt="cottage"
                  />   
                  <Typography style={this.typostyle}><Button variant="contained" size="large" color='secondary'>COTTAGE STAY</Button></Typography>
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />   
                  <Typography style={this.typostyle}><Button variant="contained" size="large" color='secondary'>HOTEL STAY</Button></Typography>
                </div>
              </div>
            </Paper>
          </Grid>
